export const MAILBOX_ACI = {
  contract: {
    ...
    typedefs: [],
    functions: [
      { name: 'version', arguments: [], returns: 'int', stateful: false, payable: false },
      { name: 'local_domain', arguments: [], returns: 'int', stateful: false, payable: false },
      { name: 'deployed_block', arguments: [], returns: 'int', stateful: false, payable: false },
      { name: 'nonce', arguments: [], returns: 'int', stateful: false, payable: false },
      { name: 'latest_dispatched_id', arguments: [], returns: 'bytes(32)', stateful: false, payable: false },
      { name: 'default_ism', arguments: [], returns: { option: ['IInterchainSecurityModule'] }, stateful: false, payable: false },
      { name: 'default_hook', arguments: [], returns: { option: ['IPostDispatchHook'] }, stateful: false, payable: false },
      { name: 'required_hook', arguments: [], returns: { option: ['IPostDispatchHook'] }, stateful: false, payable: false },
      { name: 'delivered', arguments: [{ name: 'id', type: 'bytes(32)' }], returns: 'bool', stateful: false, payable: false },
      { name: 'owner', arguments: [], returns: 'address', stateful: false, payable: false },
      {
        name: 'dispatch',
        arguments: [
          ...
          { name: 'hook_metadata', type: { option: ['bytes()'] } },
...
export const MERKLE_TREE_HOOK_ACI = {
  contract: {
    ...
    typedefs: [],
    functions: [
      { name: 'hook_type', arguments: [], returns: 'int', stateful: false, payable: false },
      { name: 'count', arguments: [], returns: 'int', stateful: false, payable: false },
      { name: 'root', arguments: [], returns: 'bytes(32)', stateful: false, payable: false },
      {
      ...
      { name: 'get_mailbox', arguments: [], returns: 'address', stateful: false, payable: false },
      {
        name: 'quote_dispatch',
        arguments: [
...
export const MULTISIG_ISM_ACI = {
  contract: {
    ...
    typedefs: [],
    functions: [
      { name: 'module_type', arguments: [], returns: 'int', stateful: false, payable: false },
      {
        name: 'get_validators',
  ...
  contract: {
    ...
    functions: [
      ...
      },
      {
        ...
        arguments: [{ name: 'entries', type: { list: [{ tuple: ['int', 'bytes(32)'] }] } }],
        returns: 'unit',
        stateful: true,
        payable: false,
      },
